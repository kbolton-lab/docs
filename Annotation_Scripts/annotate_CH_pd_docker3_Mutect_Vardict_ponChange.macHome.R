...
args <- parse_args(parser, list(c("-i","~/Bolton/data/hg38_mut_full_long_filtered_KB_deid_2.tsv"),
                                ...
                                #               sep=",")),
                                c("-v", paste("/Users/brian/Bolton/UKBB/results/lung/update/5993871_23153_0_0.mutect.vep.annotated.vcf.gz",
                                              "/Users/brian/Bolton/UKBB/results/lung/update/5993871_23153_0_0.vardict.final.annotated.vcf.gz",
                                              sep=",")),
                                ...
                                c("--mut1-bick","~/Bolton/data/topmed.mutation.1.c.p.txt"), # new
...
final.df <-  left_join(final.passed,
                       annotation %>%
                         dplyr::select("CHROM","POS","REF","ALT","SAMPLE","COSMIC_ID","CosmicCount","heme_cosmic_count","MDS",
