...
annotate.PD <- function(x) {
  ...
  translate_consequence = c(
    ...
    "coding_sequence_variant" = "feature_truncation", # missing
    "protein_altering_variant" = "feature_truncation", # missing
    ...
    "stop_lost" = "Nonsense_Mutation", # missing
    "stop_retained_variant" = "Nonsense_Mutation") # missing
