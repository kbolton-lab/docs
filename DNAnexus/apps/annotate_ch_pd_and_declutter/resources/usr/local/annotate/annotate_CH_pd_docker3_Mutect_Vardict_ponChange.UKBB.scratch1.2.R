...
repeats <- rtracklayer::import("/Users/brian/Library/CloudStorage/Box-Box/space_needed_brian/data_large/simpleRepeat.bed")
...
annotate.PD <- function(x) {
  ...
  res<-httr::content(httr::POST(url="https://www.oncokb.org/api/v1/annotate/mutations/byProteinChange", 
                                                                                      httr::add_headers(c('Content-Type'='application/json', 'Authorization'='Bearer da03f096-284a-490a-8b3f-95c5f1bf5666')), 
                                                                                      body = jsonlite::toJSON(json_query, auto_unbox = TRUE)))
  unlist(lapply(res, "[[", "oncogenic"))
  MUTS$oncoKB <- sapply(httr::content(httr::POST(url="https://www.oncokb.org/api/v1/annotate/mutations/byProteinChange", 
                                                httr::add_headers(c('Content-Type'='application/json', 'Authorization'='Bearer da03f096-284a-490a-8b3f-95c5f1bf5666')), 
                                                body = jsonlite::toJSON(json_query, auto_unbox = TRUE)), encode="text"), "[[", "oncogenic")
