...
cosmic.run(MUTS, "SAMPLE", "var_key")
...
# tumor
mutect2_vcf_file <- "/Volumes/bolton/Active/projects/TCGA/vcfs/C509.TCGA-05-5423-01A-01D-1625-08.1_gdc_realn.mutect.vep.annotated.vcf.gz"
vardict_vcf_file <- variant.files[which(grepl("vardict", variant.files))]
# tumor
vardict_vcf_file <- "/Volumes/bolton/Active/projects/TCGA/vcfs/C509.TCGA-05-5423-01A-01D-1625-08.1_gdc_realn.vardict.BCBIOfiltered.vardict.final.annotated.vcf.gz"
...
annotate.PD <- function(x) {
  ...
  # '@/Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch/44/1218352_23153_0_0.json',
  "'", jsonlite::toJSON(unname(json_query), auto_unbox = T), "'",
  ' "https://www.oncokb.org/api/v1/annotate/mutations/byProteinChange" -H "Authorization: Bearer da03f096-284a-490a-8b3f-95c5f1bf5666" | jq -r ".[].oncogenic"'), intern = T)
  
  
  write(jsonlite::toJSON(unname(json_query), auto_unbox = T), "/Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch/44/test3.json")
  
  MUTS$oncoKB <- system(command = paste0('curl -X POST -H "Content-Type: application/json" -d @/Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch/44/1218352_23153_0_0.json  "https://www.oncokb.org/api/v1/annotate/mutations/byProteinChange" -H "Authorization: Bearer da03f096-284a-490a-8b3f-95c5f1bf5666" | jq -r ".[].oncogenic"'), intern = T)
