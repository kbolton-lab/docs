...
workflow=workflow-GFp30J8JP6z3jK716KGvp4g3
...
# GERMLINE
folder=51
workflow=workflow-GBYK2ZQJP6z82z4v27zGPB1Q
...
for i in {17..60}; do;
   ...
   gsed -i "s/folder=51/folder=$i/g" /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$i/batch.sh
