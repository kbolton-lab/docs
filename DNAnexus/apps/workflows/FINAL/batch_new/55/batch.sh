...
workflow=workflow-GFy95f0JP6z21q624z81v826
...
# GERMLINE
folder=55
workflow=workflow-GBYK2bjJP6z5Zq730J589PZ4
...
for i in {17..60}; do;
   ...
   gsed -i "s/folder=55/folder=$i/g" /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$i/batch.sh
