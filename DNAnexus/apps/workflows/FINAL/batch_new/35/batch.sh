...
workflow=workflow-GBxfF2jJP6z1fgb32K5f7FVP
...
# GERMLINE
folder=35
workflow=workflow-GBYJ0v8JP6zP3B06BQGQF6bg
...
for i in {17..60}; do;
   ...
   gsed -i "s/folder=35/folder=$i/g" /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$i/batch.sh
