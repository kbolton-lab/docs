...
workflow=workflow-GBX01zjJP6z10xgg4qv27GXk
...
for dir in $(dx ls project-G8YxJ2QJP6z69ZVVFVfBYyPB:/Brian/Workflow_Outputs/); do
   dir=$(basename $dir)
   dx mv "project-G8YxJ2QJP6z69ZVVFVfBYyPB:/Brian/Workflow_Outputs/$dir/17/19*" project-G8YxJ2QJP6z69ZVVFVfBYyPB:/Brian/Workflow_Outputs/$dir/19/
done
...
for i in {17..60}; do;
   ...
   gsed -i "s/folder=19/folder=$i/g" /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$i/batch.sh
