...
workflow=workflow-GFfqkBQJP6z4k15ZK8Z325xG
...
# GERMLINE
folder=48
workflow=workflow-GBYK2YjJP6z8v7kg5JjKq5P8
...
for i in {17..60}; do;
   ...
   gsed -i "s/folder=48/folder=$i/g" /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$i/batch.sh
