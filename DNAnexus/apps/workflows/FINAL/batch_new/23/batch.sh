...
workflow=workflow-GBYJ0jQJP6z7q4py5gg6b1kX
...
for folder in $(dx ls $KELLY:/Brian/Workflow_Outputs/); do 
   folder=$(basename $folder)
   echo $folder
   dx cp "$KELLY:Brian/Workflow_Outputs/$folder/23/*" "$NEW_EXOME:Brian/Workflow_Outputs/$folder/23/"
done
...
for i in {17..60}; do;
   ...
   gsed -i "s/folder=23/folder=$i/g" /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$i/batch.sh
