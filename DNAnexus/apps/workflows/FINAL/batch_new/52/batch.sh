...
workflow=workflow-GFq2FZjJP6zG3XB15vJ7qbBB
...
# GERMLINE
folder=52
workflow=workflow-GBYK2ZjJP6z80fFv8q0KJ4F9
...
for i in {17..60}; do;
   ...
   gsed -i "s/folder=52/folder=$i/g" /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$i/batch.sh
