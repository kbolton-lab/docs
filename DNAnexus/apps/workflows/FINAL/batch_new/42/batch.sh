...
workflow=workflow-GBYK2X0JP6z0b1BP2gvJ66pK
...
for i in {17..60}; do;
   ...
   gsed -i "s/folder=42/folder=$i/g" /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$i/batch.sh
