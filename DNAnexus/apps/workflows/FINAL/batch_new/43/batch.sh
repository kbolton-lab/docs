...
workflow=workflow-GBYK2X8JP6z02Q9q3Q1Z1gX6
workflow=workflow-GFVGpg8JP6z3zyZ88PbzvYpk
...
for i in {17..60}; do;
   ...
   gsed -i "s/folder=43/folder=$i/g" /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$i/batch.sh
