...
workflow=workflow-GFxJ4q0JP6zJK3JGKpBgfxFp
...
# GERMLINE
folder=54
workflow=workflow-GBYK2bQJP6z0z7k1Px5b8PK9
...
for i in {17..60}; do;
   ...
   gsed -i "s/folder=54/folder=$i/g" /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$i/batch.sh
