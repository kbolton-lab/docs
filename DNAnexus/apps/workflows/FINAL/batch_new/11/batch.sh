...
workflow=workflow-GB064k0JP6z6FyKVPjpYpVpQ
...
cat both.txt in_progress.txt | grep -v -f /dev/stdin /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$folder/dx_batch.germline.tsv > germline.rerun.tsv && wc -l germline.rerun.tsv
