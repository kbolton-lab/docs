...
workflow=workflow-GBYJ0q8JP6zGYPp9822Qq03G
...
for i in {17..60}; do;
   ...
   gsed -i "s/folder=32/folder=$i/g" /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$i/batch.sh
