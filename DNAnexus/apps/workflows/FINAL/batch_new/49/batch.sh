...
workflow=workflow-GFgbK48JP6z3150GGF44bYvv
...
# GERMLINE
folder=49
workflow=workflow-GBYK2Z0JP6zJJf8Z5QZq2yQ6
...
for i in {17..60}; do;
   ...
   gsed -i "s/folder=49/folder=$i/g" /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$i/batch.sh
