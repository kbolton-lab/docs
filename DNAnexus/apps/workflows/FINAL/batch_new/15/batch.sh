...
workflow=workflow-GB1P9GQJP6z9Gk2bGVy7p7Yz
...
folder=15
workflow=workflow-GB1P9GQJP6z9Gk2bGVy7p7Yz
dx run $workflow --batch-tsv /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$folder/dx_batch.germline.tsv -y --priority low --extra-args '{"executionPolicy": {"restartOn": {"UnresponsiveWorker": 2}, "maxSpotTries": 5}}' --instance-type 0=mem1_ssd1_v2_x16 --instance-type 5=mem1_ssd1_v2_x16 --instance-type 2=mem2_ssd1_v2_x4

dx ls "project-G8YxJ2QJP6z69ZVVFVfBYyPB:/Brian/Workflow_Outputs/MutectVEP/$folder/*.vcf.gz" | cut -d_ -f1 | sort > mutect.germline
dx ls "project-G8YxJ2QJP6z69ZVVFVfBYyPB:/Brian/Workflow_Outputs/VardictIntersectMutect/$folder/*.vcf.gz" | cut -d_ -f1 | sort > vardict.germline
grep -f mutect.germline vardict.germline > both.txt
dx find executions -n1000 --project $NEW_EXOME --state in_progress --origin-jobs | cut -d ' ' -f2 | grep -v "^$" | cut -d- -f2 | sort > in_progress.txt
...
for i in {15..16}; do;
   ...
   sed -i "s/folder=15/folder=$i/" /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$i/batch.sh
   ...
   sed "s/\"name\": \"14\"/\"name\": \"$i\"/" /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$i/batch.sh
