...
workflow=workflow-GBYJ0k8JP6z9bV4ZG00bGBkZ
...
for i in {17..60}; do;
   ...
   gsed -i "s/folder=25/folder=$i/g" /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$i/batch.sh
