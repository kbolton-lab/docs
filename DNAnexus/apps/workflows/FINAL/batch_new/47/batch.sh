...
workflow=workflow-GFf06y8JP6z7B7JbPq7JjkKK
...
# GERMLINE
folder=47
workflow=workflow-GBYK2Y8JP6z1G0Q21X24bXQY
...
for i in {17..60}; do;
   ...
   gsed -i "s/folder=47/folder=$i/g" /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$i/batch.sh
