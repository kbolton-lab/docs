...
workflow=workflow-GB1Zg30JP6zB41ZKKXPbqQvf
...
# GERMLINE
folder=17
workflow=workflow-GBX0GxjJP6z9gpz9JffZq7YQ
...
for i in {17..60}; do;
   ...
   gsed -i "s/folder=17/folder=$i/g" /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$i/batch.sh
