...
workflow=workflow-GBYJ0x0JP6zGF0zf0v1GPqKB
...
for i in {17..60}; do;
   ...
   gsed -i "s/folder=37/folder=$i/g" /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$i/batch.sh
