...
workflow=workflow-GBYJ0y8JP6zBvfB59K806kp7
...
## single
name=4000375
dx run $workflow -istage-G4Q4Pk8J6XGFjX9F3xfbg8Qv.bam=file-FyK32qjJkF6115xX9VJfB62X -istage-G4Q4Pk8J6XGFjX9F3xfbg8Qv.bam_index=file-FyK32qjJkF65BXqZ55P0q53P -y --priority low --extra-args '{"executionPolicy": {"restartOn": {"UnresponsiveWorker": 2}, "maxSpotTries": 5}}' --instance-type 0=mem3_ssd1_v2_x8 --instance-type 2=mem2_ssd1_v2_x4 --name "$name"
...
for i in {17..60}; do;
   ...
   gsed -i "s/folder=40/folder=$i/g" /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$i/batch.sh
