...
## single
name=1010590
dx run workflow=workflow-GBYJ0xQJP6z8v7kg5JjKq2Vj -istage-G4Q4Pk8J6XGFjX9F3xfbg8Qv.bam=file-G9yjf08JP6zF11QPPpzJFB6P -istage-G4Q4Pk8J6XGFjX9F3xfbg8Qv.bam_index=file-G9yjf4jJP6z7F1Vk6zQjV8q1 -y --priority low --extra-args '{"executionPolicy": {"restartOn": {"UnresponsiveWorker": 2}, "maxSpotTries": 5}}' --instance-type 0=mem3_ssd1_v2_x8 --instance-type 2=mem2_ssd1_v2_x4 --name "$name"
...
dx run $workflow --batch-tsv /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$folder/dx_batch.germline.tsv -y --priority high --extra-args '{"executionPolicy": {"restartOn": {"UnresponsiveWorker": 2}, "maxSpotTries": 5}}' --instance-type 0=mem3_ssd1_v2_x8 --instance-type 2=mem2_ssd1_v2_x4
...
for i in {17..60}; do;
   ...
   gsed -i "s/folder=38/folder=$i/g" /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$i/batch.sh
