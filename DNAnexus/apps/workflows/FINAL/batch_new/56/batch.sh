...
workflow=workflow-GFyzYPjJP6z6Y8jPBg1qJfYV
...
# GERMLINE
folder=56
workflow=workflow-GBYK2f0JP6zBkVff3X2BP0XY
...
for i in {17..60}; do;
   ...
   gsed -i "s/folder=56/folder=$i/g" /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/FINAL/batch_new/$i/batch.sh
