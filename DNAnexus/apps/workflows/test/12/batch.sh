...
# dx run $workflow_id --batch-tsv dx_batch.0000.tsv -y --priority low
# workflow_id=workflow-G4qkQJQJ6XG0P2Bz4Qj3zxk2
# dx run $workflow_id --batch-tsv dx_batch_1.0000.tsv -y --priority low
workflow_id=workflow-G4x6JB0JQ281gy5Q4K814GXF
dx run $workflow_id --batch-tsv dx_batch_1.0001.tsv -y --priority low


workflow_id=workflow-G4x6JB0JQ281gy5Q4K814GXF
for folder in 12; do
    cd /Users/brian/Bolton/UKBB/docs/DNAnexus/apps/workflows/test/$folder
    for batch in dx_batch_1*.tsv; do
        ls $batch
