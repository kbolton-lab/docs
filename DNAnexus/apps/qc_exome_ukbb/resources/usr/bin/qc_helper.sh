...
/usr/local/openjdk-8/bin/java -Xmx16g -jar /usr/picard/picard.jar CollectAlignmentSummaryMetrics \
    INPUT=$bam_path \
...
echo "
/usr/local/openjdk-8/bin/java -Xmx16g -jar /usr/picard/picard.jar CollectHsMetrics \
    -I $bam_path \
    -R $reference_path \
