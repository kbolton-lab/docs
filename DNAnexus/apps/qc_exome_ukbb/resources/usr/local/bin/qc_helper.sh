...
/usr/local/openjdk-8/bin/java -Xmx30g -jar /usr/picard/picard.jar CollectAlignmentSummaryMetrics \
    INPUT=$bam_path \
...
/usr/local/openjdk-8/bin/java -Xmx30g -jar /usr/picard/picard.jar CollectHsMetrics \
    -I $bam_path \
    -R $reference_path \
