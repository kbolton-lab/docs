...
main() {
    ...
    ## TCGA-blah-blah-.mutect.filtered.mapq0.soft-filtered.$caller.msk.pon2.vcf.gz
    ...
    ## TCGA-blah-blah-.mutect.filtered.mapq0.soft-filtered.$caller.msk.pon2.$caller.vep.annotated.vcf.gz
