...
main() {
    ...
    #
    dx-jobutil-add-output vcf "$postprocess":vcf --class=jobref
    dx-jobutil-add-output vcf_index "$postprocess":vcf_index --class=jobref
    #
...
postprocess() {
    ...
    dx-jobutil-add-output vcf "${output_name}" --class=file 
    dx-jobutil-add-output vcf_index "${output_name}.tbi" --class=file
}
